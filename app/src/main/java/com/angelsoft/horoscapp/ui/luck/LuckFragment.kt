...
import com.angelsoft.horoscapp.databinding.FragmentLuckBinding
import com.angelsoft.horoscapp.ui.core.listener.OnSwipeTouchListener
...
class LuckFragment : Fragment() {
    ...
    private fun preparePrediction() {
        val luckyModel = randomCardProvider.getLucky()
        luckyModel?.let { luck ->
            binding.tvLucky.text = getString(luck.text)
            binding.ivLuckyCard.setImageResource(luck.image)
            binding.btnShare.setOnClickListener { shareResult(getString(luck.text)) }
        }
    }
